# Tutorial: marcos disparo em massa
...
|---|---|---|
| `048-...` | Aba Listas: lista de contatos importada | NAO |
| `046-...` | Aba Campanhas: campanha pausada + boas praticas | SIM (sobrenome no texto) |
| `047-...` | Aba Dashboard: metricas de entrega | SIM (cabecalho) |
| `049-...` | Modal 'Importar Lista de Contatos' | SIM (cabecalho) |
