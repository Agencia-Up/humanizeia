...
|---|---|---|
| `060-...` | Configuracoes do Kanban Pedro (7 colunas) | NAO |
| `038-...` | Kanban em conta real durante arraste de coluna | SIM (muitos leads reais) |
| `039-...` | Kanban com tooltip 'Mover coluna' | SIM (muitos leads reais) |
| `040-...` | Kanban com card sendo arrastado | SIM (muitos leads reais) |
