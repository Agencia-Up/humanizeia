...
- MERGEAR na `main` (fluxo normal) `create-evolution-instance` (+47 linhas) e `handle-instance-ban` (+16) que estao deployadas em prod a partir de STAGING (melhoria "vendedor conecta instancia", 2026-06-02). Estao no ar mas NAO na `main` -> se alguem deployar essas duas da `main`, perde a melhoria. Promover pelo fluxo padrao.
