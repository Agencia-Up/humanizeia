-- Pedro v3: bind each asynchronous conversation to the WhatsApp instance
-- that received it. The instance is routing data, not an agent preference.
...
begin
  ...
  if v_instance_id is not null
     ...
     and v_instance_id <> p_instance_id then
...
-- Compatibility for old/single-instance callers during a rolling deploy.
