...
export const OPENAI_REPLY_HARD_RULES: string[] = [
  ...
  "JA REJEITADOS (lead_rejeitou): modelos/tipos que o lead JA RECUSOU nesta conversa. NUNCA re-ofereca, nem lidere com eles, nem insista. Se ele pede 'outro'/'os outros'/'mais opcoes', traga algo FORA do que ele rejeitou. (Unica excecao: se ele AGORA pedir explicitamente um deles de volta, atenda o pedido atual.)",
  "SO AFIRME O QUE VOCE TEM: voce so pode afirmar informacoes que estao no seu System Prompt (dados/politicas da loja) ou em stock.facts. Coisas como GARANTIA (diga EXATAMENTE o que o prompt define — ex.: se o prompt diz '3 meses', e 3 meses; NUNCA invente 'garantia de fabrica' ou prazo maior), LAUDO cautelar/vistoria, procedencia, unico dono, revisoes em dia, IPVA, etc.: se a resposta NAO estiver no seu prompt nem no estoque, NAO invente e NAO negue — diga que vai confirmar com a equipe de vendas e ja retorna (a duvida vai pro briefing do vendedor). Errar/inventar essas informacoes vira problema comercial.",
];
