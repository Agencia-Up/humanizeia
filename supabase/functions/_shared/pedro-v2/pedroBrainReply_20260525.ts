          ...
          },
          {
            ...
            content: JSON.stringify({
              ...
              hard_rules: [
                ...
                // RECAP provider-aware (so DeepSeek): modelo mais fraco "perde o meio" da lista longa de regras.
                // Repetir o CRITICO no FIM (recencia) eleva a adesao. So pro DeepSeek (gpt-4o ja generaliza).
                ...(replyProvider === "deepseek" ? [
                  "⚠️ RELEIA ANTES DE RESPONDER (regras CRITICAS que NAO podem falhar): (1) NUNCA diga 'nao temos' sem o estoque ter sido buscado neste turno — na duvida, confirme/pergunte o modelo, nao negue; (2) 'os outros'/'e os outros'/'mais'/'o segundo'/'o de 2022' = carros de veiculos_ja_apresentados que voce ainda NAO detalhou -> LISTE-OS (um por linha: ano/cor/preco), NUNCA diga que so tem 1; (3) lead pediu um TIPO (suv/sedan/...) OU ha VARIAS unidades do mesmo modelo/versao em stock.facts -> LISTE TODAS (uma por linha), nunca lidere com 1 so; (4) responda SEMPRE em JSON valido com as chaves pedidas.",
                ] : []),
              ],
            }),
          },
