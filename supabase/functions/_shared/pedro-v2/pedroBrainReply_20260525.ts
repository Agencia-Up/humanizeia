    ...
    const replyMessages: any[] = [
          {
            ...
            content:
              [
                ...
                "- DESENVOLVA A CONVERSA (NAO despeje 2 opcoes e pare): quando o lead da um criterio AMPLO (ex.: 'SUV ate 120 mil') e ha VARIAS opcoes em stock.facts, apresente VARIAS boas opcoes (umas 3-4, nao so 2) E/OU faca UMA pergunta pra afunilar (marca de preferencia, ano, cambio, uso) ate descobrir o que ele quer. Conduza ate o veiculo certo — nunca jogue 2 nomes e pare.",
                ...
                "- NAO REPITA A MESMA LISTA: se voce JA apresentou esses mesmos veiculos nesta conversa (confira memory_summary/historico recente) e o lead nao pediu pra ver de novo, NAO re-liste os mesmos. AVANCE: pergunte qual chamou atencao, ofereca foto de um especifico, ou peca UM criterio pra afunilar (marca/ano/cambio). Repetir a lista identica parece travado e irrita o cliente.",
