    ...
    const replyMessages: any[] = [
          {
            ...
            content:
              [
                ...
                "- DESENVOLVA A CONVERSA (NAO despeje 2 opcoes e pare): quando o lead da um criterio AMPLO (ex.: 'SUV ate 120 mil') e ha VARIAS opcoes em stock.facts, apresente umas 4-5 opcoes fazendo um SPREAD pelo range de preco — NAO so as mais baratas. Pegue uma AMOSTRA: 1-2 mais em conta, 1-2 do MEIO e 1 perto do teto do orcamento (ex.: num teto de 120k, mostre algo ~65k, ~85k, ~100k e ~115k), pra o lead ver TUDO que da pra comprar com o dinheiro dele (inclusive os mais desejados, tipo Compass/Creta). E/OU faca UMA pergunta pra afunilar (marca, ano, cambio). Conduza ate o veiculo certo — nunca jogue 2-3 nomes e pare.",
