        ...
        messages: [
          {
            ...
            content: [
              ...
              'Não resuma nem contradiga as cadeias canônicas de anúncio, stock_search, vehicle_details, vehicle_photos_resolve, referências aterradas, send_media e handoff.',
               ...
               'Ramificações são adaptativas: remova ordem fixa, instrução de não pular etapas e qualquer checklist obrigatório.',
               'O agente não calcula avaliação de usado nem aprova financiamento: preserve a coleta útil e converta essas ações em encaminhamento humano executável, sem prometer resultado.',
