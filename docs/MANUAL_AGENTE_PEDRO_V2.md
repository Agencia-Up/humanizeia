...
- 2026-06-25 ? v202 ? Continua??o de op??es preserva o perfil anterior: "tem mais op??es?" agora for?a nova busca de estoque herdando tipo/faixa (ex.: SUV at? 70k) e n?o relaxa para hatches/sedans aleat?rios; `buildStockFilters` mant?m o teto anterior mesmo com an?ncio em contexto. Tamb?m protege `pedro_conversation_state.lead.nome` contra placeholder "Lead".
