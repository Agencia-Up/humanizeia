...
|---|---|---|
| `019-...` | Agente IA: fluxo em 3 passos e card do agente | NAO |
| `020-...` | Modal Editar Agente (aba Geral) + Conexao WhatsApp | NAO |
| `021-...` | Rodape do Editar Agente: horario e categorias | NAO |
