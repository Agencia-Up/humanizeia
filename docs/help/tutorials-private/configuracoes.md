...
|---|---|---|
| `061-...` | Configuracoes + aba Kanban Marcos | SIM (cabecalho) |
| `062-...` | Configuracoes > Dashboard TV (identidade visual) | SIM (cabecalho) |
| `064-...` | Regras & Automacoes (topo) | SIM (cabecalho) |
| `063-...` | Regras & Automacoes (fim): relatorios | SIM (numero de WhatsApp) |
