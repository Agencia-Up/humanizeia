...
-- CUMULATIVE R13-D PATCH (audit Codex)
-- Pedro v3 - R13-D/1: promoção accepted-safe da WorkingMemory (escrita avulsa de WM por CAS).
-- Idêntico a Brain/sql/v3_r13d_wm_outcome_patch.sql. Recebe SÓ a WorkingMemory; atualiza só workingMemory/
-- appliedAcceptedEffectIds/version/updatedAt (preserva o resto byte-a-byte); idempotente; não toca photoLedger.
