...
export type QueryInputMap = {
  stock_search: { tipo?: VehicleType; cambio?: TransmissionPreference; precoMax?: number; modelo?: string; marca?: string; anos?: number[]; popular?: boolean; broad?: boolean; excludeKeys?: string[]; includeMotorcycles?: boolean };
