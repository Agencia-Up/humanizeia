        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-6">
          <section>
            ...
            <p className="text-muted-foreground">
              Ao acessar ou usar a plataforma Logos IA, você concorda em cumprir estes Termos de Serviço. Se você não concordar com qualquer parte destes termos, não poderá acessar ou usar nossos serviços.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Ao conectar contas de plataformas de terceiros (Meta, Google, TikTok, Shopify), você autoriza a Logos IA a acessar e processar os dados disponibilizados conforme as permissões concedidas. A Logos IA não se responsabiliza por alterações nas APIs ou políticas dessas plataformas que possam afetar o funcionamento dos serviços.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Todo o conteúdo, design, código e funcionalidades da plataforma são propriedade da Logos IA. Os conteúdos gerados pela IA para o usuário (copies, criativos, relatórios) são de propriedade do usuário que os gerou.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              A Logos IA fornece insights e recomendações baseados em IA como ferramenta de apoio à decisão. Não garantimos resultados específicos de campanhas publicitárias. O usuário é o único responsável pelas decisões tomadas com base nas informações fornecidas pela plataforma.
            </p>
          </section>
