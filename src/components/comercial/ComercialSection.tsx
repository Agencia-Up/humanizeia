    ...
    <Card className="painel-geral-card overflow-hidden rounded-2xl border">
      <CardContent className="p-4">
        <div className="flex items-center gap-2 mb-1.5">
          <span className={`h-8 w-8 rounded-xl flex items-center justify-center ring-1 ring-border/40 dark:ring-white/10 ${accent}`}><Icon className="h-4 w-4" /></span>
...
export function ComercialSection({
  ...
  return (
    <div className="painel-geral-panel space-y-4 rounded-3xl border p-4">
      {/* Header do bloco comercial */}
      <div className="painel-geral-control flex items-center justify-between flex-wrap gap-3 rounded-2xl border px-4 py-3">
