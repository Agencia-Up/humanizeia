...
set "PROJECT_REF=ezoltigtqgbmftmiwjxh"

echo.
echo Configuracao local do Supabase para o projeto LogosIA-baseTeste
echo Esse token ficara salvo apenas neste projeto, em arquivo ignorado pelo Git.
echo.
set /p TOKEN=Cole aqui o token sbp_ da conta do LogosIA-baseTeste: 
...
echo scripts\supabase-logosia-staging.cmd functions list --project-ref %PROJECT_REF%
